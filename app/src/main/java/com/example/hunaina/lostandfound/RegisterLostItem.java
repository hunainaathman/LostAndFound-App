...
public class RegisterLostItem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setLogo(R.drawable.register);
    ...
    private void registerLostItem() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, SAVE_URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                Toast.makeText(RegisterLostItem.this, response, Toast.LENGTH_LONG).show();
            }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(RegisterLostItem.this, error.toString(), Toast.LENGTH_LONG).show();
